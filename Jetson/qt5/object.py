...
def run_detect(opt_input_uri, opt_output_uri, opt_crop_uri, out_q):
  ...
  while True:
    ...
    if len(detected_cars):
      ...
      if swerve.erraticDriverDetected:
        out_q.put(handle_erratic(opt_input_uri, opt_crop_uri, cnt, detected_cars[0]))
        print("Erratic Driver Detected! Gettin out of here!")
        break
