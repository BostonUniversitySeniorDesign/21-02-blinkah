...
class HomePage(QtWidgets.QWidget):
    ...
    def logo_img(self):
        ...
        Logo.setText(
            "<html><head/><body><p><img src=\"./graphics/logo_256x256.png\"/></p></body></html>")
        return Logo
    ...
    def b_img(self):
        ...
        B.setObjectName("B")
        B.setText(
            "<html><head/><body><p><img src=\"./graphics/b_200x200.png\"/></p></body></html>")
        return B
    ...
    def go_btn(self):
        ...
        go_btn.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./graphics/chevron.png"),
...
class NavPage(QtWidgets.QWidget):
    ...
    def press_next(self):
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("graphics/next_arrow.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.On),
